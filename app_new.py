...
with right:
    ...
    if "result" in st.session_state:
        ...
        risk_label = "High Risk"  if prob_churn >= 0.70 else ("Medium Risk" if prob_churn >= 0.40 else "Low Risk")
        risk_color = "#ff4d6d"    if prob_churn >= 0.70 else ("#e2b96a"     if prob_churn >= 0.40 else "#2ddbb0")
        eng_s      = r["eng_score"]
